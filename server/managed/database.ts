...
export class Event extends Entity<EventQueryProxy> {
	$$meta = {
		tableName: "event",
		columns: {"id":{"type":"uuid","name":"id"},"date":{"type":"date","name":"date"},"name":{"type":"text","name":"name"},"link":{"type":"text","name":"link"},"hash":{"type":"text","name":"hash"},"imageUrl":{"type":"text","name":"image_url"},"ticketLink":{"type":"text","name":"ticket_link"},"ticketAvailable":{"type":"bool","name":"ticket_available"},"ticketPrice":{"type":"float4","name":"ticket_price"},"highlight":{"type":"bool","name":"highlight"},"hostId":{"type":"uuid","name":"host_id"}},
...
export class Session extends Entity<SessionQueryProxy> {
	$$meta = {
		tableName: "session",
		columns: {"id":{"type":"uuid","name":"id"},"key":{"type":"text","name":"key"},"createdAt":{"type":"timestamp","name":"created_at"},"height":{"type":"float4","name":"height"},"width":{"type":"float4","name":"width"},"headers":{"type":"text","name":"headers"},"ip":{"type":"text","name":"ip"}},
