...
export class EventQueryProxy extends QueryProxy {
	...
	get imported(): Partial<QueryTimeStamp> { throw new Error("Invalid use of QueryModels. QueryModels cannot be used during runtime"); }
	get description(): Partial<QueryString> { throw new Error("Invalid use of QueryModels. QueryModels cannot be used during runtime"); }
	get importer(): Partial<QueryString> { throw new Error("Invalid use of QueryModels. QueryModels cannot be used during runtime"); }
	get name(): Partial<QueryString> { throw new Error("Invalid use of QueryModels. QueryModels cannot be used during runtime"); }
...
export class Event extends Entity<EventQueryProxy> {
	...
	$$meta = {
		...
		columns: {
			...
			imported: { type: "timestamp", name: "imported" },
			description: { type: "text", name: "description" },
			importer: { type: "text", name: "importer" },
			name: { type: "text", name: "name" },
